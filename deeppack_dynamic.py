...
torch.save(model.state_dict(), "deeppack_dynamic_0119_model_0328.pt")
...
plt.savefig("0328_train_loss610.png")

plt.figure(figsize=(10,7))
plt.plot(rewards)
plt.xlabel("Episodes",fontsize=22)
plt.ylabel("Reward",fontsize=22)
plt.savefig("0328_train_reward610.png")

plt.figure(figsize=(10,7))
plt.plot(accept_prob_per_board)
plt.xlabel("boards",fontsize=22)
plt.ylabel("accept_prob",fontsize=22)
plt.savefig("0328_train_accept_prob_per_board610.png")

plt.figure(figsize=(10,7))
plt.plot(PE_per_baord)
plt.xlabel("episodes",fontsize=22)
plt.ylabel("PE",fontsize=22)
plt.savefig("0328_train_PE_per_baord610.png")
